...
<br/><a href="https://interactive-or.com/">Interactive-OR Lab</a>
  <br/><span style="color:red;">Keywords:</span> Computer Vision, YOLOv8, Object Detection
</div>
...
<br/><a href="https://interactive-or.com/">Interactive-OR Lab</a>
  <br/><span style="color:red;">Keywords:</span> Computer Vision, YOLOv8, Object Tracking
</div>
...
<br/><a href="https://interactive-or.com/">Interactive-OR Lab</a>
<br/><span style="color:red;">Keywords:</span> Graph Neural Network, Gradient Boosted Trees, Urban Planning Insight
</div>
...
<br/><span style="color:red;">Keywords:</span> Gini Feature Importance, RankLib, Learning to Rank, Random Forests
...
<div style="width: 70%; float: left;">
  ...
  <br/><a href="https://ls3.rnet.torontomu.ca/">Laboratory for Systems, Software and Semantics</a>
  <br/><span style="color:red;">Keywords:</span> Question routing, Expert finding, Embedding, Learning to rank, Multimodal Representation
</div>
